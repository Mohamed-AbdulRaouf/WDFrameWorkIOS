...
extension ProductViewController{
    func setupUI(){
        ...
        self.addToCartButton.titleLabel?.font = APP_FONT_BOLD13 //UIFont(resource: APP_FONT_BOLD, size: 13)
        self.addToCartButton.setTitle("add_to_cart".localized().localized(), for: .normal)
