...
//        currentWindow?.addSubview(container)
        ...
        errorButton.tag = 999
        let iconImage:UIImage? = UIImage.getFontAwaseomImage(fontName: "fas fa-info-circle",imageSize: CGSize(width: 20, height: 20))

        
        errorButton.setImage(iconImage, for: .normal)
